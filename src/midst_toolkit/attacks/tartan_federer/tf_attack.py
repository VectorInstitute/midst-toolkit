...
from midst_toolkit.attacks.tartan_federer.classification import MLP, fitmodel
...
# TODO: remove addt_value from here and other places since not needed for single table attack
...
# TODO: change x_train_label to y_train
