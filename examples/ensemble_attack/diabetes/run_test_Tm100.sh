...
# TARGET_IDS=(8)
TARGET_IDS=(10)  # List of target IDs
...
python -m examples.ensemble_attack.diabetes.test_attack_model --config-name=diabetes_experiment_config_Tm100 target_model.target_model_id=$TARGET_ID
