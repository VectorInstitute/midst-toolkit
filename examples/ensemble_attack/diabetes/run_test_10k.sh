...
#SBATCH --mem=150G
#SBATCH --job-name=test_uniform_44
...
python -m examples.ensemble_attack.diabetes.test_attack_model --config-name=diabetes_experiment_config_10k_uniform_44 target_model.target_model_id=$TARGET_ID
