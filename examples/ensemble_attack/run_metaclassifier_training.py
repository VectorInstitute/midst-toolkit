...
def run_metaclassifier_training(
    ...
    y_meta_train_1 = np.load(
        "/projects/midst-experiments/ensemble_attack/number_of_target/42/attack_data/master_challenge_train_labels.npy"
    )

    y_meta_train_2 = np.load(
        "/projects/midst-experiments/ensemble_attack/number_of_target/44/attack_data/master_challenge_train_labels.npy"
    )

    y_meta_train_3 = np.load(
        "/projects/midst-experiments/ensemble_attack/number_of_target/45/attack_data/master_challenge_train_labels.npy"
    )

    y_meta_train = np.concatenate([y_meta_train_1, y_meta_train_2, y_meta_train_3], axis=0)
    ...
    features_dir_1 = "/projects/midst-experiments/ensemble_attack/number_of_target/42/attack_data/extracted_features/meta_train_features_42.csv"
    df_meta_train_1 = pd.read_csv(features_dir_1)

    features_dir_2 = "/projects/midst-experiments/ensemble_attack/number_of_target/44/attack_data/extracted_features/meta_train_features_44.csv"
    df_meta_train_2 = pd.read_csv(features_dir_2)

    features_dir_3 = "/projects/midst-experiments/ensemble_attack/number_of_target/45/attack_data/extracted_features/meta_train_features_45.csv"
    df_meta_train_3 = pd.read_csv(features_dir_3)

    #concatenate the two dataframes
    df_meta_train = pd.concat([df_meta_train_1, df_meta_train_2, df_meta_train_3], ignore_index=True)
    ...
    log(INFO, "Metaclassifier model saved to , starting evaluation...")
