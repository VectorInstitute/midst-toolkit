...
#SBATCH --mem=128G
#SBATCH --job-name=test20_200_all_targets
...
python -m examples.ensemble_attack.test_attack_model --config-name=experiment_config_20k_200k target_model.target_model_id=$TARGET_ID
