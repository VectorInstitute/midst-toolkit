...
def test_autheticity_only_categorical_direct_one_hot():
    ...
    # Merge one-hot encoded categorical data with numerical data
    ...
    # Compute authenticity using AlphaPrecision
...
def test_authenticity_only_numerical():
    # Define numerical real and synthetic data
