...
import pandas as pd
import numpy as np
from midst_toolkit.attacks.ept.feature_extraction import preprocess_train_predict, main as run_feature_extraction_main, TaskType
...
def test_main_feature_extraction(sample_dataframes, sample_column_types):
    ...
    expected_columns = [
        # Numerical 1
        "num_col_1", "num_col_1_error", "num_col_1_error_ratio", "num_col_1_prediction",
        # Numerical 2
        "num_col_2", "num_col_2_error", "num_col_2_error_ratio", "num_col_2_prediction",
        # Categorical 1
        "cat_col_1", "cat_col_1_accuracy", "cat_col_1_prediction",
        # Categorical 2
        "cat_col_2", "cat_col_2_accuracy", "cat_col_2_prediction",
    ]
    
    assert sorted(list(df_results.columns)) == sorted(expected_columns)
