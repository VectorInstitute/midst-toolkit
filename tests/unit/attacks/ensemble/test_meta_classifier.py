...
MOCK_COLUMN_TYPES_CONTENT = {"numerical": ["numerical_col1", "numerical_col2"], "categorical": ["cat_col1"]}
...
class TestBlendingPlusPlus:
    ...
    def test_prepare_meta_features(
        self, mock_read_csv, mock_domias, mock_gower, mock_file, mock_config_with_json_path, sample_dataframes
    ):
