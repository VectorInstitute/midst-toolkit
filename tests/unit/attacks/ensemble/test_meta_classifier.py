...
class TestBlendingPlusPlus:
    ...
    def test_init_success(self, mock_file, mock_config_with_json_path):
        ...
        bpp_lr = BlendingPlusPlus(config=mock_config_with_json_path, meta_classifier_type=MetaClassifierType("lr"))
    ...
    def test_init_invalid_type_raises_error(self, mock_file, mock_config_with_json_path):
        ...
        with pytest.raises(ValueError):
            BlendingPlusPlus(config=mock_config_with_json_path, meta_classifier_type=MetaClassifierType("svm"))
    ...
    def test_prepare_meta_features(self, mock_read_csv, mock_domias, mock_gower, mock_file, mock_config_with_json_path, sample_dataframes):
        ...
        bpp = BlendingPlusPlus(config=mock_config_with_json_path)
    ...
    def test_fit_logistic_regression(self, mock_lr, mock_prepare_features, mock_file, mock_config_with_json_path, sample_dataframes):
        ...
        bpp = BlendingPlusPlus(config=mock_config_with_json_path, meta_classifier_type=MetaClassifierType("lr"))
        bpp.fit(
    ...
    def test_fit_xgboost(self, mock_tuner_class, mock_prepare_features, mock_file, mock_config_with_json_path, sample_dataframes):
        ...
        bpp = BlendingPlusPlus(config=mock_config_with_json_path, meta_classifier_type=MetaClassifierType("xgb"))
        bpp.fit(
            df_train=sample_dataframes["df_train"],
            y_train=sample_dataframes["y_train"],
            df_synthetic=sample_dataframes["df_synth"],
    ...
    def test_predict_raises_error_if_not_fit(self, mock_file, mock_config_with_json_path, sample_dataframes):
        ...
        # Configure the mock file for __init__
        mock_file.return_value.read.return_value = json.dumps(MOCK_COLUMN_TYPES_CONTENT)
    ...
    def test_predict_flow(self, mock_get_tpr, mock_prepare_features, mock_file, mock_config_with_json_path, sample_dataframes):
